...
class HulpverlenerHomeWidget extends StatefulWidget {
  const HulpverlenerHomeWidget({super.key});

  static String routeName = 'HulpverlenerHome';
  static String routePath = '/hulpverlenerHome';

  @override
  State<HulpverlenerHomeWidget> createState() => _HulpverlenerHomeWidgetState();
}
                  ...
                  child: Column(
                    ...
                    children: [
                                  ...
                                  children: [
                                    ...
                                    if (FFAppState().TeamId != null)
                                      TextButton(
                                        onPressed: () async {
                                          if (FFAppState().TeamId != null) {
                                            // Stop location tracking for current team
                      ...
                      Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(
                            16.0, 0.0, 16.0, 0.0),
                        child: StreamBuilder<List<InterventieRecord>>(
                          stream: queryInterventieRecord(
                            queryBuilder: (interventieRecord) =>
                                interventieRecord
                                    .where(
                                      'teamId',
                                    ...
                                    .where(
                                      'status',
                                      isEqualTo:
                                          Statusinterventie.active.serialize(),
                                    )
                                    .where(
                                      'eventId',
                                      isEqualTo: FFAppState().Event.id,
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<InterventieRecord>
                                containerInterventieRecordList = snapshot.data!;
                            final containerInterventieRecord =
                                containerInterventieRecordList.isNotEmpty
                                    ? containerInterventieRecordList.first
                                    : null;
                                  ...
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          containerInterventieRecord != null
                                              ? 'Actief'
                                              : 'Geen Actief',
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                    ...
                                    Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          if (containerInterventieRecord != null
                                              ? false
                                              : true)
                                            Align(
                                              alignment: AlignmentDirectional(
