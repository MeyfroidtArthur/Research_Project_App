        ...
        WidgetsBinding.instance.addPostFrameCallback((_) async {
          ...
          if (_previousStatus != slachtofferVideoConnectionRecord.status) {
            ...
            if (slachtofferVideoConnectionRecord.status == Statuscall.waiting ||
              ...
              try {
                await _locationService.startTracking(referencePath);
                print(
                    '✅ Slachtoffer: Location tracking started for path: $referencePath');
              } catch (e) {
                print('❌ Slachtoffer: Error starting location tracking: $e');
              }
