...
import 'schema/connection_record.dart';
...
export 'schema/connection_record.dart';
...
/// Functions to query ConnectionRecords (as a Stream and as a Future).
Future<int> queryConnectionRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      ConnectionRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<ConnectionRecord>> queryConnectionRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      ConnectionRecord.collection,
      ConnectionRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<ConnectionRecord>> queryConnectionRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query InterventieRecords (as a Stream and as a Future).
Future<int> queryInterventieRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      InterventieRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<InterventieRecord>> queryInterventieRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      InterventieRecord.collection,
      InterventieRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<InterventieRecord>> queryInterventieRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
